                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12 footer-links  category sidebar-category-block">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="<?=$CONFIG['sitio']?>paginas/NuestroInst/AcercaNos.php">Nuestro Instituto</a></li>
                                    <li><a href="<?=$CONFIG['sitio']?>paginas/Transparencia/transparencia.php">Transparencia</a></li>
                                    <li><a href="<?=$CONFIG['sitio']?>paginas/Servicios/denuncia.php">Servicios</a></li>
                                    <li><a href="<?=$CONFIG['sitio']?>paginas/Transparencia/unidadestransparencia.php">Sujetos Obligados</a></li>
                                    <li><a href="<?=$CONFIG['sitio']?>contacto.php">Contáctanos</a></li>
                                </ul>
