                            ...
                            <div class="page-bg-color">
                                ...
                                <div class="image-dis clearfix cv-theme-30">
                                    <div class="about-image-block">
                                        <div class="col-md-12 col-sm-12 col-xs-12 about-image">
                                            <img src="<?=$CONFIG['sitio']?>img/organigrama_old.jpg" align="middle" alt="photo" title="" height="100%" width="100%" class="img-responsive">
                                        </div>
                                    </div>
