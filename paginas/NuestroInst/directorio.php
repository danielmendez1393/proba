		...
		<section class="team-section-block main-contain">
                <div class="container">
                    ...
                    <div class="row">
                           <div class="col-md-12">
                           <div class="text-center">
                                    	<h5><li class="fa fa-file-excel-o"><a title="Excel" href="excel.php" target="_blank">&nbsp;&nbsp;Directorio completo</a></li></h5>
                                    </div>
                               <div class=" page-bg-color">
                                   ...
                                   <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-6 col-xs-12 team-member">
                                            <div class="team-img">
                                            <img src="<?=$CONFIG['sitiodirectorio']."fotos/".$dato['foto']?>" alt="photo" title="" class="img-responsive">
                                            </div>
                                            <div class="team-content text-center">
                                                <h5 class="team-title"><?=strtoupper($dato['nombre'])?></h5>
                                                <div class="team-title"><strong><?=$dato['cargo']?></strong></div>
                                                <div class="team-title"><a href="mailto:<?=$dato['email']?>" ><?=$dato['email']?></a></div>
                                                <div class="team-title"><?=$dato['telefono']?></div>
                                                <!--div class="team-title"><?=$dato['direccion']?></div-->
                                                <!--ul class="header-social-icons">
                                                    ...
                                                    <li class="social-icons"><a title="Linkedin" href="#"><i class="fa fa-linkedin"></i></a></li>
                                                    <li class="social-icons"><a title="Dribbble"  href="#"><i class="fa fa-dribbble"></i></a></li>
                                                    <li class="social-icons"><a title="Linkedin"  href="#"><i class="fa fa-linkedin"></i></a></li>
                                                    <li class="social-icons"><a title="Pinterest" href="#"><i class="fa fa-pinterest"></i></a></li>
                                                </ul-->
                                            </div>
                                        </div>
                                        <?php
