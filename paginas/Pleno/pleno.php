                                             ...
                                             <!-- Start Left Sidebar Categories -->
                                                <div class="sidebar-block category sidebar-category-block cv-theme-30">
                                                    ...
                                                    <ul class="list-unstyled">
                                                        <li  class="active" ><a href="<?=$CONFIG['sitio']?>paginas/pleno/pleno.php">Pleno</a></li>
                                ...
                                <!-- End Sidebar Categories -->
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-12 ">
                                        <div class="about-dis-block">
                                            <h3 class="cv-theme-widget-title">
                                                <span class="main-border">Pleno</span>
                                            </h3>
                                           
                                            <img src="../../img/comisionados/pleno.jpg" align="middle" alt="photo" title=""  class="img-responsive">
                                            <p>
                                            Es el órgano supremos del Instituto el cual esta compuesto por tres comisionados, con duración en el cargo de 7 años, y son nombrados por el congreso del Estado de Sonora.
											</p>
