...
$convocatorias = $objPleno->convocatorias();
$actas = $objPleno->actas();
unset($objPleno);
                                             ...
                                             <!-- Start Left Sidebar Categories -->
                                                <div class="sidebar-block category sidebar-category-block cv-theme-30">
                                                    ...
                                                    <ul class="list-unstyled">
                                                        ...
                                                        <li  class="active"><a href="<?=$CONFIG['sitio']?>paginas/pleno/sesiones.php">Sesiones</a></li>
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-12 ">
                                        <div class="about-dis-block">
                                            ...
                                            <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="row">
                                                                 Última Sesión del Pleno Jurídica:<br>
                                                                 Última Sesión de Pleno Administrativa:
                                                        </div>
                                                        <div class="row">
                                                                Próxima Sesión del Pleno Jurídica:<br>
                                                                Próxima Sesión de Pleno Administrativa:
                                                        </div>
                                                    </div>
                                                    <div class="col-md-5">
                                            ...
                                            <h4 class="cv-theme-widget-title">
                                                <span class="main-border">Actas del Pleno</span>
                                            </h4>
                                        ...
                                        <div align="right">
                                             <form name="bsqActaAnio" action="sesiones.php" method="post">
                                            ...
                                            ?>
                                             <p> <b>Actas del Año <?=$_POST['anio']?$_POST['anio']:date('Y')?></b></p>
											...
											<?php
                                             if( count($actas) > 0 ){
												 foreach($actas as $num => $acta){
                                                    if( $anio1 != $acta['act_anio']){
                                                        $anio1 = $acta['act_anio']; 
                                                ?>
                                                		</div>
                                                        <p><b>Año <?=$anio1?></b></p>
                                            	...
                                            	<ul class="list-goup">
                                                       <a class="list-group-item" href="<?=$CONFIG['actas'].$acta['act_archivo']?>"> <li class="fa fa-file-pdf-o "> &nbsp; Acta # <?=$acta["act_num"]?> <em> Fecha de Acta: <?=$acta["act_fecha"]?></em> </li></a>
                                                       </ul> 
                                             </div> 
                                                 <?php
                                                 }
                                             }else{
                                                 echo "No se encontraron convocatorias del año seleccionado";
                                                 }
        ...
        <script type="text/javascript">
            $(function() {
                ...
                $('#calendar').fullCalendar({
					googleCalendarApiKey: 'AIzaSyDsvOsjKBCmZUxelHzNvNI0BMk6HWTUlys',
					events: {
						googleCalendarId: '2pj7h2qlm3hfpbuu595fvffgkk@group.calendar.google.com',
