                                             ...
                                             <!-- Start Left Sidebar Categories -->
                                                <div class="sidebar-block category sidebar-category-block cv-theme-30">
                                                    ...
                                                    <ul class="list-unstyled">
                                                        ...
                                                        <li  class="active"><a href="<?=$CONFIG['sitio']?>paginas/pleno/estrados.php">Estrados Electrónicos</a></li>
                                                    </ul>
                                                </div>
                                <!-- End Sidebar Categories -->
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-12 ">
                                        <div class="about-dis-block">
                                            <h3 class="cv-theme-widget-title">
                                                <span class="main-border">Estrados Electrónicos</span>
                                            </h3>
                                                                                    
                                            <p>
                                            
                                            <div align="center">
                                            <img class="img-responsive" src="../../img/construccion.gif">
