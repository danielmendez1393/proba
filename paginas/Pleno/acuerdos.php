...
$acuerdos = $objPleno->acuerdos($_GET['actual']);
unset($objPleno);
?>
<!DOCTYPE html>
                                             ...
                                             <!-- Start Left Sidebar Categories -->
                                                <div class="sidebar-block category sidebar-category-block cv-theme-30">
                                                    ...
                                                    <ul class="list-unstyled">
                                                        ...
                                                        <li class="active"><a href="<?=$CONFIG['sitio']?>paginas/pleno/acuerdos.php?actual=1">Acuerdos</a></li>
                                                        <li><a href="<?=$CONFIG['sitio']?>paginas/pleno/resoluciones.php">Resoluciones</a></li>
                                                        <li><a href="<?=$CONFIG['sitio']?>paginas/pleno/sesiones.php?actual=1">Sesiones</a></li>
                                ...
                                <!-- End Sidebar Categories -->
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-12 ">
                                        <div class="about-dis-block">
                                            <h3 class="cv-theme-widget-title">
                                                <span class="main-border">Listas de Acuerdos</span>
                                            </h3>
                                             <div align="right">
                                                 <form name="bsqActaAnio" action="acuerdos.php" method="post">
                                                 ...
                                                 ?>
                                                 <option <?php if($i== ($_POST['anio']?$_POST['anio']:date('Y')) ) echo "SELECTED"?>><?=$i?></option>
                                                 <?php
                                                 }
                                                 ?>
                                            ...
                                            ?>
                                             <p> <b>Listas de Acuerdos del Año <?=$_POST['anio']?$_POST['anio']:date('Y')?></b></p>
											...
											<?php
                                             if( count($acuerdos) > 0 ){
                                                 foreach($acuerdos as $num => $acuerdo){
                                                    if( $anio1 != $acuerdo['acr_anio']){
                                                        $anio1 = $acuerdo['acr_anio']; 
                                                ?>
                                                        <p><b>Año <?=$anio1?></b></p>
                                                ...
                                                <?php
                                                 ...
                                                 ?>
                                                       <a href="<?=$CONFIG['acuerdos'].$acuerdo['acr_archivo']?>"> <li class="fa fa-file-pdf-o"> &nbsp; Lista <?=$acuerdo["acr_fecha"]?> <em> Fecha de Publicación: <?=$acuerdo["acr_fecha"]?></em> </li></a>
                                                 <?php
                                                 }
                                             }else{
                                                 echo "No se encontraron listas de acuerdos del año seleccionado";
                                                 }
